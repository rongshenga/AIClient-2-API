...
const translations = {
    'zh-CN': {
        ...
        'oauth.modal.step3': '授权完成后页面会自动保存凭据',
        ...
        'modal.provider.filter.errorType': '错误类型:',
        ...
        'modal.provider.refreshHealth': '刷新健康状态',
        'modal.provider.refreshHealthConfirm': '确定要刷新此节点的健康状态吗？\n\n节点 uuid: {uuid}\n\n这将立即发送健康检测请求。',
        'modal.provider.refreshHealth.running': '正在刷新健康状态...',
        'modal.provider.refreshHealth.success': '健康状态已刷新：节点可用',
        'modal.provider.refreshHealth.unhealthy': '健康状态已刷新：节点异常',
        'modal.provider.refreshHealth.notSupported': '当前提供商类型不支持健康检测',
        'modal.provider.refreshHealth.failed': '刷新健康状态失败',
        ...
        'modal.provider.deleteUnhealthyConfirm': '确定要删除 {count} 个不健康节点吗？此操作不可逆。',
        'modal.provider.deleteUnhealthyConfirmByError': '确定要删除 {count} 个{errorType}不健康节点吗？此操作不可逆。',
        ...
        'modal.provider.deleteUnhealthy.errorTypeLabel': '错误类型',
        'modal.provider.deleteUnhealthy.errorType.all': '全部错误',
        'modal.provider.deleteUnhealthy.errorType.auth': '认证错误',
        'modal.provider.deleteUnhealthy.errorType.quota': '配额/限流',
        'modal.provider.deleteUnhealthy.errorType.timeout': '超时',
        'modal.provider.deleteUnhealthy.errorType.network': '网络错误',
        'modal.provider.deleteUnhealthy.errorType.other': '其他错误',
        'modal.provider.deleteUnhealthy.errorType.unknown': '未知错误',
        ...
        'usage.empty': '展开分组后可手动刷新该提供商用量',
        'usage.noData': '暂无用量数据',
        'usage.noInstances': '暂无已初始化的服务实例',
        'usage.group.instances': '{count} 个实例',
        'usage.group.success': '{count}/{total} 成功',
        'usage.group.clickToLoad': '点击上方分组标题加载详情',
        'usage.group.refreshPage': '刷新本页',
        'usage.group.refreshAll': '刷新全部',
        'usage.group.prevPage': '上一页',
        'usage.group.nextPage': '下一页',
        'usage.group.pageStatus': '第 {page}/{totalPages} 页 · 共 {count} 个实例',
        ...
        'usage.taskCompletedSummary': '刷新完成：正常 {normal}，额度用光 {quotaExhausted}，异常 {exception}',
        'usage.taskFailed': '后台刷新失败',
        'usage.taskCancel': '取消刷新',
        'usage.taskCanceling': '取消中...',
        'usage.taskCanceled': '刷新已取消',
        'usage.allProviders': '全部提供商',
        'usage.refreshScope.page': '当前页',
        'usage.refreshScope.providerAll': '该提供商全部账号',
        'usage.refreshEstimateConfirm': '将刷新 {provider} 全部 {count} 个账号，预计耗时约 {seconds} 秒。已完成部分会保留，是否继续？',
        'usage.group.taskRunning': '后台刷新中',
        'usage.group.taskPending': '等待首批进度...',
        'usage.group.taskInlineMeta': '已刷新 {processed}/{total}',
        ...
        // Tutorial
        'tutorial.title': '配置教程',
        'tutorial.config.title': '配置与存储说明',
        'tutorial.config.desc': '配置以 Web UI 保存为主，configs/ 目录用于启动参数与兼容导入导出。运行时数据可按后端写入文件或 SQLite。',
        ...
        'tutorial.config.file.pools': '提供商池兼容快照文件。启用 DB 后主要用于迁移、导入导出和回滚工件，不再是唯一数据源',
        ...
        'tutorial.storage.title': 'Runtime Storage (DB-only)',
        'tutorial.storage.desc': '运行时数据统一使用 sqlite 数据库存储（DB-only）。',
        'tutorial.storage.table.title': '关键参数',
        'tutorial.storage.backend': '运行时存储后端固定为 db',
        'tutorial.storage.dbPath': 'SQLite 数据库路径',
        'tutorial.storage.dualWrite': '双写模式已下线',
        'tutorial.storage.autoImport': '启动时自动导入历史 provider pools 快照到 DB',
        'tutorial.storage.fallback': '文件回退模式已下线',
        'tutorial.storage.migration': '迁移建议：先执行 npm run runtime-storage:admin -- migrate 预演，再用 --execute 落地，最后执行 verify --fail-on-diff 校验。',
        'tutorial.pool.title': '提供商池兼容数据 (provider_pools.json)',
        'tutorial.pool.desc': '该结构仍用于导入导出、兼容工具链与排障。db 模式下，运行时以数据库中的 provider 数据为准。',
