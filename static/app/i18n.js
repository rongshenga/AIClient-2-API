...
const translations = {
    ...
    'en-US': {
        ...
        'oauth.gemini.batchImportDesc': 'Support JSON paste and folder batch import (multiple files)',
        'oauth.gemini.modeJson': 'Paste JSON',
        'oauth.gemini.modeFolder': 'Import Folder',
        'oauth.gemini.tokensLabel': 'Token Data (JSON Object/Array)',
        'oauth.gemini.tokensPlaceholder': 'Paste JSON containing access_token/refresh_token, or account object with token field...',
        'oauth.gemini.importInstructions': 'Two methods are supported: 1) paste JSON; 2) select a folder and parse all JSON files automatically.',
        'oauth.gemini.uploadFolder': 'Select JSON Folder',
        'oauth.gemini.folderDragDrop': 'Drag and drop a folder here',
        'oauth.gemini.folderClickUpload': 'or click to select a folder',
        'oauth.gemini.folderHint': 'Each JSON file can be a single object or array, including { token: {...} } format.',
        'oauth.gemini.selectedFiles': 'Parsed Files',
        'oauth.gemini.clearFiles': 'Clear',
        'oauth.gemini.folderNoJson': 'No importable JSON files found in selection',
        'oauth.gemini.fileParseError': 'Failed to parse file {filename}',
        'oauth.gemini.fileNoValidObjects': 'No importable JSON objects in file',
        'oauth.gemini.fileTokenCount': '{count} token(s)',
        ...
        'oauth.codex.selectMethod': 'Select Authentication Method',
        'oauth.codex.oauth': 'OAuth Login',
        'oauth.codex.oauthDesc': 'Open browser and authorize a single account.',
        'oauth.codex.batchImport': 'Batch Import JSON',
        'oauth.codex.batchImportDesc': 'Import multiple accounts from JSON text or folders.',
        'oauth.codex.batchImportTitle': 'Codex Batch Import',
        'oauth.codex.batchImportHint': 'Supports automatic field recognition for Codex credentials. Required minimal field: <code>access_token</code>.',
        'oauth.codex.hardwareHint': 'Hardware threads detected: {threads}, recommended import concurrency: {importConcurrency}, refresh concurrency: {refreshConcurrency}.',
        'oauth.codex.modeJson': 'JSON Text',
        'oauth.codex.modeFolder': 'Folder Import',
        'oauth.codex.tokensLabel': 'Paste JSON object/array',
        'oauth.codex.tokensPlaceholder': '{"access_token":"...","refresh_token":"...","email":"..."}',
        'oauth.codex.folderHint': 'Click or drag a folder with JSON files.',
        'oauth.codex.selectedFiles': 'Selected Files',
        'oauth.codex.clearFiles': 'Clear',
        'oauth.codex.skipDuplicateCheck': 'Skip duplicate check (faster)',
        'oauth.codex.refreshAfterImport': 'Refresh token after import',
        'oauth.codex.importConcurrency': 'Import concurrency',
        'oauth.codex.refreshConcurrency': 'Refresh concurrency',
        'oauth.codex.tokenCount': 'Total credential objects',
        'oauth.codex.importing': 'Importing...',
        'oauth.codex.importingProgress': 'Importing {current}/{total}...',
        'oauth.codex.startImport': 'Start Import',
        'oauth.codex.done': 'Done',
        'oauth.codex.noValidObjects': 'No valid JSON object found.',
        'oauth.codex.folderNoJson': 'No JSON files found in selected folder.',
        'oauth.codex.fileParseError': 'Failed to parse {filename}: {message}{extra}',
        'oauth.codex.noCredentials': 'No credential objects to import.',
        'oauth.codex.importSuccess': 'Imported {count} credentials successfully.',
        'oauth.codex.importAllFailed': 'All imports failed ({count}).',
        'oauth.codex.importPartial': 'Partial success: {success} success, {failed} failed.',
        'oauth.codex.importFailed': 'Import failed: {error}',
        ...
        'modal.provider.filter.label': 'Show:',
        'modal.provider.filter.all': 'All',
        'modal.provider.filter.healthy': 'Healthy Only',
        'modal.provider.filter.unhealthy': 'Unhealthy Only',
        'modal.provider.filter.empty': 'No nodes match current filter',
        'modal.provider.add': 'Add Provider',
        'modal.provider.grokBatchImport': 'Batch Import SSO',
        'modal.provider.grokBatchImportTitle': 'Batch Import Grok SSO Tokens',
        'modal.provider.grokBatchImportDesc': 'Enter one SSO token per line. The system will create grok-custom nodes in batch with shared common settings below.',
        'modal.provider.grokBatchImportTokensLabel': 'SSO Token List',
        'modal.provider.grokBatchImportTokensPlaceholder': 'One token per line\nExample:\nsso_xxx\naaa.bbb.ccc\nsso=ddd.eee.fff',
        'modal.provider.grokBatchImportCount': 'Pending count:',
        'modal.provider.grokBatchImportCustomPrefix': 'Node Name Prefix',
        'modal.provider.grokBatchImportCustomPrefixPlaceholder': 'e.g.: Grok-Node',
        'modal.provider.grokBatchImportStart': 'Start Batch Import',
        'modal.provider.grokBatchImporting': 'Importing...',
        'modal.provider.grokBatchImportNoTokens': 'Please enter at least one valid SSO token',
        'modal.provider.grokBatchImportSuccess': 'Import successful: {count} nodes created',
        'modal.provider.grokBatchImportPartial': 'Partial success: {success} succeeded, {failed} failed',
        'modal.provider.grokBatchImportFailed': 'Import failed: {count} tokens were not imported',
        ...
        'usage.clickToRefreshConfirm': 'Click to refresh this provider (with confirmation)',
