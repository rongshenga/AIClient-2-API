...
describe('API Integration Tests with HTTP Requests', () => {
    ...
    // npx jest ./tests/integration/api-integration.test.js -t "OpenAI Compatible Endpoints"
    describe('OpenAI Compatible Endpoints', () => {
        // To run this test:
        // npx jest ./tests/integration/api-integration.test.js -t "OpenAI /v1/chat/completions non-streaming Gemini"
        ...
        // To run this test:
        // npx jest ./tests/integration/api-integration.test.js -t "OpenAI /v1/chat/completions streaming Gemini"
        ...
        // To run this test:
        // npx jest ./tests/integration/api-integration.test.js -t "OpenAI /v1/chat/completions non-streaming with OpenAI provider"
        ...
        // To run this test:
        // npx jest ./tests/integration/api-integration.test.js -t "OpenAI /v1/chat/completions streaming with OpenAI provider"
        ...
        // To run this test:
        // npx jest ./tests/integration/api-integration.test.js -t "OpenAI /v1/chat/completions non-streaming with Claude provider"
        ...
        // To run this test:
        // npx jest ./tests/integration/api-integration.test.js -t "OpenAI /v1/chat/completions streaming with Claude provider"
    ...
    // npx jest ./tests/integration/api-integration.test.js -t "Claude Native Endpoints"
    describe('Claude Native Endpoints', () => {
        // To run this test:
        // npx jest ./tests/integration/api-integration.test.js -t "Claude /v1/messages non-streaming"
        ...
        // To run this test:
        // npx jest ./tests/integration/api-integration.test.js -t "Claude /v1/messages streaming"
    ...
    // npx jest ./tests/integration/api-integration.test.js -t "Claude Kiro Endpoints"
    describe('Claude Kiro Endpoints', () => {
        // To run this test:
        // npx jest ./tests/integration/api-integration.test.js -t "Claude Kiro /v1/messages non-streaming"
        ...
        // To run this test:
        // npx jest ./tests/integration/api-integration.test.js -t "Claude Kiro /v1/messages streaming"
    ...
    // npx jest ./tests/integration/api-integration.test.js -t "Gemini Native Endpoints"
    describe('Gemini Native Endpoints', () => {
        // To run this test:
        // npx jest ./tests/integration/api-integration.test.js -t "Gemini /v1beta/models/{model}:generateContent"
        ...
        // To run this test:
        // npx jest ./tests/integration/api-integration.test.js -t "Gemini /v1beta/models/{model}:streamGenerateContent"
    ...
    // npx jest ./tests/integration/api-integration.test.js -t "Model List Endpoints"
    describe('Model List Endpoints', () => {
        // To run this test:
        // npx jest ./tests/integration/api-integration.test.js -t "OpenAI /v1/models Gemini"
        ...
        // npx jest ./tests/integration/api-integration.test.js -t "OpenAI /v1/models OpenAI"
        ...
        // npx jest ./tests/integration/api-integration.test.js -t "OpenAI /v1/models Claude"
        ...
        // To run this test:
        // npx jest ./tests/integration/api-integration.test.js -t "Gemini /v1beta/models modelList"
    ...
    // npx jest ./tests/integration/api-integration.test.js -t "Authentication Tests API KEY"
    describe('Authentication Tests API KEY', () => {
        // To run this test:
        // npx jest ./tests/integration/api-integration.test.js -t "Reject requests without API key"
        ...
        // To run this test:
        // npx jest ./tests/integration/api-integration.test.js -t "Accept query parameter authentication"
        ...
        // To run this test:
        // npx jest ./tests/integration/api-integration.test.js -t "Accept Bearer token authentication"
        ...
        // To run this test:
        // npx jest ./tests/integration/api-integration.test.js -t "Accept x-goog-api-key authentication"
        ...
        // To run this test:
        // npx jest ./tests/integration/api-integration.test.js -t "Accept x-api-key authentication for Claude"
    ...
    // npx jest ./tests/integration/api-integration.test.js -t "Error Handling Tests"
    describe('Error Handling Tests', () => {
        // To run this test:
        // npx jest ./tests/integration/api-integration.test.js -t "Handle invalid JSON in request body"
        ...
        // To run this test:
        // npx jest ./tests/integration/api-integration.test.js -t "Handle unsupported endpoints"
    ...
    // npx jest ./tests/integration/api-integration.test.js -t "CORS Headers Test"
    describe('CORS Headers Test', () => {
        // To run this test:
        // npx jest ./tests/integration/api-integration.test.js -t "CORS headers support"
